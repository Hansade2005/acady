...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      content: "The 3 a Skill Passport transformed how employers view my skills. It's proof, not just claims!",
      rating: 5,
      date: "December 2024"
    },
    {
  ...
  const howItWorksSteps = [
    ...
    { icon: <CheckCircle size={40} className="text-green-400" />, title: "Get Verified", desc: "Earn your 3 a Skill Passport with a Confidence Score." },
  ...
  const tabContent = {
    Students: {
      icon: <GraduationCap />,
      text: "Plan your career and turn your academic projects and internships into verifiable proof of workplace readiness. Stand out to employers before you even graduate and land your dream job faster."
    },
    Professionals: {
      icon: <Briefcase />,
      text: "Showcase your real-world experience and upskilling efforts. Use your 3 a Skill Passport to validate your expertise, negotiate raises, and transition into new roles with confidence."
    },
    Employers: {
      icon: <Building />,
      text: "Hire with more confidence. Move beyond the resume and interviews to see verified proof of a candidate's abilities. Reduce hiring risk, save time, and find the perfect fit, faster."
    }
  };
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-black text-gray-300 font-sans">
                ...
                <ul className="space-y-6">
                  {[
                    { 
                      ...
                      text: "Issues the 3 a Skill Passport: A proof-based evolution of the resume"
                    },
                    {
        ...
        >
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                {
                  title: "3 a Skill Passport",
                  desc: "A digital record of proven skills offered in English and French.",
                  icon: <GraduationCap size={56} className="text-indigo-400" />,
                  gradient: "from-indigo-600/20 to-purple-600/20",
                  glow: "rgba(99, 102, 241, 0.3)"
                },
                {
                  title: "TalentVisa – Proof of job-market readiness",
                  desc: "A readiness credential issued after full verification of skills and professional behavior. It signals to employers that you are prepared, reliable, and job market-ready.",
                  icon: <Globe size={56} className="text-purple-400" />,
                  gradient: "from-purple-600/20 to-pink-600/20",
                  glow: "rgba(168, 85, 247, 0.3)"
                },
                {
                  title: "T3X Talent Exchange – Connection to real opportunities",
                  desc: "A dynamic talent marketplace where verified candidates meet hiring managers who value proof over promises. It turns workplace readiness into real-world access and career mobility.",
                  icon: <ArrowRightLeft size={56} className="text-pink-400" />,
                  gradient: "from-pink-600/20 to-indigo-600/20",
                  glow: "rgba(236, 72, 153, 0.3)"
                },
                {
                  title: "LiveWorks Studio – Learn by doing real projects",
                  desc: "A live work environment where learners apply their skills to real contracts and gain hands-on experience before employment, while clients receive cost-effective solutions to their needs. Each project strengthens both your portfolio and your confidence.",
                  icon: <Building size={56} className="text-teal-400" />,
                  gradient: "from-teal-600/20 to-cyan-600/20",
                  glow: "rgba(20, 184, 166, 0.3)"
                },
                {
                  title: "Civic Access Lab – Tools for Education, Housing & Civic Support",
                  desc: "A one-stop digital hub helping residents, newcomers, and students plan and navigate forms, benefits, and local programs. It bridges civic systems with human guidance for smoother access.",
                  icon: <Users size={56} className="text-cyan-400" />,
              ...
              {[
                {
                  ...
                  desc: "Learn by doing real projects - coming Q3 2026. A live work environment where learners apply their skills to real contracts and gain hands-on experience.",
        ...
        {/* Meet the 3 a Skill Passport - Immersive */}
        <motion.section
          id="passport"
          className="py-32 relative overflow-hidden"
          variants={containerVariants}
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-16 items-center">
              ...
              <motion.div variants={itemVariants} className="relative group order-1 md:order-2">
                ...
                <motion.img
                  src="https://api.a0.dev/assets/image?text=A digital record of proven skills offered in English and French with afew graphs for the growth curve and indices.&aspect=4:3&seed=passport_hologram"
                  alt="3 a Skill Passport Visualization"
                  className="relative rounded-3xl shadow-2xl border border-white/10"
                  whileHover={{ 
                    scale: 1.05,
                    rotateY: 10,
        ...
        >
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              Sign up for the 3 a Skill Passport and get early access to new features, insights, and opportunities.
            </motion.p>
            <motion.div
