      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed inset-4 md:bottom-24 md:right-8 md:left-auto md:top-auto z-50 w-auto md:w-96 h-auto md:h-[500px] max-w-[calc(100vw-2rem)] max-h-[calc(100vh-2rem)] md:max-h-[calc(100vh-8rem)] bg-black/95 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl overflow-hidden"
          >
            {/* Chat Header */}
            ...
            {/* Messages */}
            <div className="flex-1 overflow-y-auto p-4 space-y-4 min-h-[200px] max-h-[calc(100%-200px)] md:h-[350px]">
